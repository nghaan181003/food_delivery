...
import 'package:food_delivery_h2d/features/admin/update_request/controllers/partner_update_request_controller.dart';
...
class PartnerUpdateRequestScreen extends StatelessWidget {
  PartnerUpdateRequestScreen({super.key});
  final controller = Get.put(PartnerUpdateRequestController());
        ...
        return Scaffold(
          body: Padding(
            ...
            child: Column(
              children: [
                Text(
                  "Danh sách yêu cầu chỉnh sửa thông tin của đối tác",
