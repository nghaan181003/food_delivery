...
import 'package:food_delivery_h2d/features/admin/dashboard/controllers/daily_revenue_admin_controller.dart';
...
class DailyRevenueChart extends StatelessWidget {
  DailyRevenueChart({super.key});
  final controller = Get.put(DailyRevenueAdminController());
