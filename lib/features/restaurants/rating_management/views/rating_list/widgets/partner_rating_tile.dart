...
import 'package:food_delivery_h2d/features/restaurants/voucher_management/view/send_voucher.dart';
...
class PartnerRatingTile extends StatelessWidget {
  final RatingModel rating;

  const PartnerRatingTile({super.key, required this.rating});
