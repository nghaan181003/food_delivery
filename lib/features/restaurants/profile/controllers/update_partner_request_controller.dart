...
class UpdatePartnerRequestController extends GetxController{
  static UpdatePartnerRequestController get instance => Get.find();
  ...
  Future<void> fetchAllPartnerRequest() async {
    try {
      ...
      final data = await _repository.fetchAllPartnerRequest(LoginController.instance.currentUser.userId);
