...
import 'package:food_delivery_h2d/features/restaurants/setting_schedule/controllers/schedule_controller.dart';
...
class _ScheduleScreenState extends State<ScheduleScreen> {
  ...
  void initState() {
    super.initState();
    controller
        .fetchDetailPartner(LoginController.instance.currentUser.partnerId)
        .then((_) {
      final partner = controller.detailPartner.value;
      if (partner != null) {
        for (var daySchedule in partner.schedule) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(title: Text("Lịch đóng/mở quán")),
      body: Obx(() {
        final partner = controller.detailPartner.value;
                            ...
                            Align(
                              ...
                              child: TextButton.icon(
                                onPressed: () async {
                                  ...
                                  if (newSlot != null) {
                                    setState(() {
                                      final scheduleList = controller
                                          .detailPartner.value!.schedule;
                                      final existing =
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  final currentSchedule =
                      controller.detailPartner.value?.schedule ?? [];
                  ...
                  await scheduleController.updateSchedule(scheduleToSave);
                },
